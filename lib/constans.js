...
module.exports = {
  ...
  VALIDATED_FIELDS: {
    NAME: Joi.string()
      .pattern(/^[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]{3,80}$/)
      .required()
      .messages({
    ...
    PASSWORD: Joi.string().messages({
      ...
      "string.pattern.base": "El campo password debe contener al menos una letra mayúscula, una letra minúscula, un número y un carácter especial, y tener una longitud mínima de 8 caracteres",
    ...
    IMG: Joi.string()
      ...
      .messages({
        ...
        "string.pattern.base": 'El campo img debe empezar con "/" o "https:" ',
    ...
    STATUS: Joi.string().min(0).max(10).required().messages({
    ...
    BIRTHDATE: Joi.string()
      .pattern(/^(19[0-9]{2}|20[0-9]{2})-(0[1-9]|1[0-2])-([0-2][0-9]|3[01])$/)
      .required()
      .messages({
