...
module.exports = {
  ...
  VALIDATED_FIELDS: {
    ...
    REGION: Joi.string().required().messages({
      'string.base': 'El campo region debe ser de tipo string',
      'string.empty': 'El campo region no puede estar vacío',
      'any.required': 'El campo region es requerido'
    }),
    NAME_VIDEO: Joi.string().required().messages({
      'string.base': 'El campo region debe ser de tipo string',
      'string.empty': 'El campo region no puede estar vacío',
      'any.required': 'El campo region es requerido'
    }),
    POSITION: Joi.string().required().messages({
      'string.base': 'El campo position debe ser de tipo string',
      'string.empty': 'El campo position no puede estar vacío',
      'any.required': 'El campo position es requerido'
    }),
    ...
    ORDER_ID: Joi.string().required().messages({
      'string.base': 'El campo order_id debe ser de tipo string',
      'string.empty': 'El campo order_id no puede estar vacío',
      'any.required': 'El campo order_id es requerido'
    }),
    SHIP_ID: Joi.string().required().messages({
      'string.base': 'El campo ship_id debe ser de tipo string',
      'string.empty': 'El campo ship_id no puede estar vacío',
      'any.required': 'El campo ship_id es requerido'
    }),
    PAY_METHOD: Joi.string().required().messages({
      'string.base': 'El campo pay_method debe ser de tipo string',
      'string.empty': 'El campo pay_method no puede estar vacío',
      'any.required': 'El campo pay_method es requerido'
    }),
    GIFT: Joi.boolean().required().messages({
      'boolean.base': 'El campo gift debe ser de tipo boolean',
      'boolean.empty': 'El campo gift no puede estar vacío',
      'any.required': 'El campo gift es requerido'
    }),
    MODEL: Joi.string().required().messages({
      'string.base': 'El campo model debe ser de tipo string',
      'string.empty': 'El campo model no puede estar vacío',
      'any.required': 'El campo model es requerido'
    }),
    CONDITIONS: Joi.string().required().messages({
      'string.base': 'El campo conditions debe ser de tipo string',
      'string.empty': 'El campo conditions no puede estar vacío',
      'any.required': 'El campo conditions es requerido'
    }),
    COLOR: Joi.string().required().messages({
      'string.base': 'El campo color debe ser de tipo string',
      'string.empty': 'El campo url no puede estar vacío',
      'any.required': 'El campo color es requerido'
    }),
    ...
    CUSTOMER: Joi.object().required().messages({
      'object.base': 'El campo customer debe ser de tipo Object',
      'any.required': 'El campo customer es requerido'
    }),
    ...
    BENEFIT_ARRAY: Joi.array().required().messages({
      'array.base': 'El campo benefit, tiene que ser tipo Array',
      'array.empty': 'El campo benefit no puede ser un campo vacio',
      'any.required': 'El campo benefit es requerido'
    }),
    SALE: Joi.array().required().messages({
      'array.base': 'El campo sale, tiene que ser tipo Array',
      'array.empty': 'El campo sale no puede ser un campo vacio',
      'any.required': 'El campo sale es requerido'
    }),
    ...
    SIZES: Joi.array().required().messages({
      'array.base': 'El campo sizes, tiene que ser tipo Array',
      'array.empty': 'El campo sizes no puede ser un campo vacio',
      'any.required': 'El campo sizes es requerido'
    }),
  ...
  MESSAGE_RESPONSE: {
    ...
    GAME_CREATED_SUCCESS: "El juego se creó correctamente.",
    GAME_CREATED_FAILED: "El juego no se creó.",
    GAME_COLLECTION_EMPTY: "No hay juegos disponibles.",
    GAME_UPDATE_SUCCESS: "El juego se actualizo correctamente.",
