...
const messages = [
  {
    ...
    Que tal soy Daphne de virtual voices, estoy emocionada de poder ayudarte, ¿Dime porque te interesa nuestro servicio?`,
  },
];

module.exports = async function generateAgentTest(userInput) {
  messages.push({
    role: "user",
    content: userInput,
  });
