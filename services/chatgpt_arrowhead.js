...
const { dataRealState } = require("../db/realstate");
const openai = new OpenAI({
  apiKey: process.env.OPENAI_API_KEY,
});


module.exports = async function generatePersonalityResponseRealState(message, number) {
  try {
const reponse = await dataChatGpt();
    ...
    mapMessage.unshift({ role: "system", content: dataRealState });
